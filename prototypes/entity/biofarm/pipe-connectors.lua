...
function assembler2pipepicturesCokery()
  return
  {
    north =
    {
      filename = "__mojo-resource-processing__/graphics/icons/empty.png",
      priority = "extra-high",
      width = 32,
      height = 32,
      shift = {0.09375, 0.4375}
...
function assembler2pipepicturesBioreactor()
  return
  {
    ...
    east =
    {
      filename = "__mojo-resource-processing__/graphics/entity/biofarm/pipe-east.png",
      priority = "extra-high",
      width = 41,
      height = 40,
      shift = {-0.71875, 0}
    ...
    south =
    {
      filename = "__mojo-resource-processing__/graphics/entity/biofarm/pipe-south.png",
      priority = "extra-high",
      width = 41,
      height = 40,
      shift = {0.0625, -0.8}
    ...
    west =
    {
      filename = "__mojo-resource-processing__/graphics/entity/biofarm/pipe-west.png",
      priority = "extra-high",
      width = 41,
      height = 40,
      shift = {0.78125, 0.03125}
