	...
	----------------------------------------------------------------------------------
 	{
		...
		icon = "__mojo-resource-processing__/graphics/icons/water-well/water-well.png",
		...
		animation =
		{
			filename = "__mojo-resource-processing__/graphics/entity/water-well/water-well-pump-anim.png",
			priority = "high",
			width = 116,
			height = 110,
			frame_count = 40,
